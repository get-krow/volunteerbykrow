      ...
      <div>
        ...
        <div className="h-16 px-5 flex items-center gap-3 border-b border-gray-50">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-[#635BFF] flex items-center justify-center text-white shadow-md shadow-purple-500/20 flex-shrink-0">
            ...
            {!isCollapsed && (
              <div className="flex flex-col">
                <span className="font-extrabold text-base text-gray-900 tracking-tight leading-none">
                  VOLUNTEER <span className="text-[#635BFF]">BY KROW</span>
                </span>
                <span className="text-[9px] text-gray-400 font-semibold tracking-wider uppercase mt-0.5">
