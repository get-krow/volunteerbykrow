...
export default function DashboardPage() {
  ...
  return (
    <MainLayout>
      {currentUser ? (
        <VolunteerDashboard currentUser={currentUser} onOpenAuth={() => setIsAuthOpen(true)} />
      ) : (
        <div className="max-w-md mx-auto my-20 p-8 bg-white rounded-3xl border border-gray-200 shadow-sm text-center space-y-4">
          <h2 className="text-xl font-extrabold text-gray-900">Volunteer Dashboard</h2>
          <p className="text-xs text-gray-500 font-medium">Please sign in to view your dashboard, hours, and saved shifts.</p>
          <button
