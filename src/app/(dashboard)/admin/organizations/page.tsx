...
const orgs = [
  { id: 1, name: "Green Earth Foundation", type: "nonprofit", status: "verified" },
  { id: 2, name: "Bright Futures Academy", type: "school", status: "verified" },
  { id: 3, name: "Youth Art Collective", type: "club", status: "pending" },
];
